...
var sprite_avatar
var current_happiness = 65
var max_happiness = 100
var min_happiness = 0


#Emotion Sprites
@onready var neutral_expression = "res://Sprites/Sarah/Sarah-Neutral.png"
@onready var happy_expression = "res://Sprites/Sarah/Sarah-Happy.png"
@onready var scared_expression = "res://Sprites/Sarah/Sarah-Scared.png"
@onready var sad_expression = "res://Sprites/Sarah/Sarah-Sad.png"
@onready var angry_expression = "res://Sprites/Sarah/Sarah-Angry.png"
@onready var excited_expression = "res://Sprites/Sarah/Sarah-Excited.png"
...
func send_initial_prompt():
	...
	Of the three patients in the game, you have the easy difficulty.
	...
	For example, your starting message can go like this: {'Emotion':'Sad', 'Message':'Hi Doctor, I'm Sarah. I've been having some troubles recently.', 'EmotionAmount':'7'}. 
	Replace the single quotes with quotation marks to make it more like proper JSON format. 
	Only respond in JSON format.
	The emotions available to you during this roleplay session are: Happy, Sad, Excited, Angry, Scared, Neutral.
	...
	Your personality: Sarah is a cheery and aloof girl who wants to make friends. Her dream is to become an actress.
	Your problem: Social Anxiety, Self-esteem issues, bullied in the past, has trouble talking to people.
	Your likes: Flowers, Pizza, Animals, Family, Serving Others, Nice Weather, Encouragement and words of affirmation.
