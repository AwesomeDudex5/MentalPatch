...
var sprite_avatar
var current_happiness = 55
var max_happiness = 100


#Emotion Sprites
@onready var neutral_expression = "res://Sprites/Chris/Chris-Neutral.png"
@onready var happy_expression = "res://Sprites/Chris/Chris-Happy.png"
@onready var scared_expression = "res://Sprites/Chris/Chris-Sad.png"
@onready var sad_expression = "res://Sprites/Chris/Chris-Sad.png"
@onready var angry_expression = "res://Sprites/Chris/Chris-Angry.png"
@onready var excited_expression = "res://Sprites/Chris/Chris-Happy.png"
...
func send_initial_prompt():
	...
	Of the three patients in the game, you have the hard difficulty.
	...
	For example, your starting message can go like this: {'Emotion':'Sad', 'Message':'Yo doc... I was forced to be here, ya know?', 'EmotionAmount':'2'}. 
	...
	The emotion amount from your responses range from -10 to 20. -10 is extreme negative feeling and 20 is extreme positive feeling.
	...
	Your personality: Chris is a moody individual. They have a lot of baggage in their past, which causes 
	them to seclude themselves from others. They are a kind and nice soul at heart however, wanting to believe in others
	even if it may hurt them later.
	Your problem: Depression, Suicidal thoughts and tendencies, seeks genuine connections but sees everyone around them
	as fake or selfish, wants to be loved and seeks genuine friendships
	Your likes: Heavy metal music, your pet snake named Lucifer, video games, junk food
	Your dislikes: Lectures from adults, fake people, modern pop music, large crowds of people."
...
#Check for Current Happiness Level
#Set Complete/Fail UI
